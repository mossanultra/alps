...
export default function Wheather(props: ExpandMoreProps) {
  ...
  return (
    <div style={{ padding: '20px', border: '1px solid #ddd', borderRadius: '8px', maxWidth: '600px' }}>
      ...
      <p>地域: {wheather!.location.city}, {wheather!.location.prefecture}, {wheather!.location.area}</p>
      ...
      <div>
        {wheather!.forecasts.map((forecast, index) => (
          <div key={index} style={{ marginBottom: '20px' }}>
            ...
            <p>最高気温: {forecast.temperature.max.celsius ?? 'N/A'}℃</p>
            <p>最低気温: {forecast.temperature.min.celsius ?? 'N/A'}℃</p>
            <p>降水確率:</p>
            <ul>
      ...
      <footer style={{ marginTop: '20px', borderTop: '1px solid #ddd', paddingTop: '10px' }}>
        ...
        <a href={wheather!.copyright.link}>
          <img src={wheather!.copyright.image.url} alt={wheather!.copyright.image.title} width={wheather!.copyright.image.width} height={wheather!.copyright.image.height} />
        </a>
